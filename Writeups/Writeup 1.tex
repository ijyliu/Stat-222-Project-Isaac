...
\begin{document}
    ...
    Drop cases where dates do not agree between not agree between tabular financial sources

    Drop cases where filing date falls outside of fixed quarter

    Drop cases hwere filing date more than 45 days after earnings call
    ...
    \begin{table*}
        ...
        \input{../Output/Modelling/Autogluon/ag-20240331_233723_feature_importance.tex}
        \label{tab:autogluon-feature-importance}
    \end{table*}

    In Table, \ref{tab:autogluon-feature-importance}
