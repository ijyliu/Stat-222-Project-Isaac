...
\begin{document}
    ...
    \begin{table*}[h!]
        ...
        \begin{minipage}[c]{0.45\linewidth}
            ...
            \input{../Output/Modelling/Logistic Regression/Tables/include_previous_model_comparison_df.tex}
            %\label{tab:most-complex-classification-report}
        \end{minipage}
        \begin{minipage}[c]{0.45\linewidth}
            \centering
            \caption{\footnotesize Exclude Previous Rating} 
            \input{../Output/Modelling/Logistic Regression/Tables/exclude_previous_model_comparison_df.tex}
